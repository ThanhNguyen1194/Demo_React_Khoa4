...
import { GET_ALL_COMMENTS, GET_ALL_COMMENTS_SAGA, INSERT_COMMENT_SAGA } from '../../../redux/constants/Cyberbugs/CommentConstans';
...
export default function ModalCyberBugs(props) {
    ...
    const renderListComment = () =>{
        return listComment.map((comment, index) => {
            return  <div key={index} className="comment-item" style={{ backgroundColor: '#ecedf0' }}>
            <div className="display-comment" style={{ display: 'flex',marginBottom: '15px' }}>
                ...
                <div>
                    ...
                    <div>
                        <button style={{ color: '#929398', border:"none", outline: "none",backgroundColor:"transparent",color:"blueviolet" }}>Edit</button>
                        •
                        <button style={{ color: '#929398', border:"none",outline: "none",backgroundColor:"transparent",color: "red"  }}>Delete</button>
                    </div>
                </div>
            </div>
        </div>

...
import { INSERT_COMMENT_SAGA } from '../../../redux/constants/Cyberbugs/CommentConstans';
...
export default function ModalCyberBugs(props) {
    ...
    const renderListComment = () =>{
        return listComment.map((comment, index) => {
            ...
            <div className="display-comment" style={{ display: 'flex',marginBottom: '10px' }}>
                ...
                <div>
                    ...
                    <div>
                        <button style={{ color: '#929398', border:"none", outline: "none" }}>Edit</button>
                        •

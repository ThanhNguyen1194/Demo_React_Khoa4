...
import { DELETE_COMMENT, DELETE_COMMENT_SAGA, GET_ALL_COMMENTS, GET_ALL_COMMENTS_SAGA, INSERT_COMMENT_SAGA } from '../../../redux/constants/Cyberbugs/CommentConstans';
            ...
            return <div key={index} className="comment-item">
                <div className="display-comment" style={{ display: 'flex', marginBottom: '15px' }}>
                    ...
                    <div style={{ backgroundColor: '#ecedf0', width: '100%', padding: '10px', borderRadius: '10px' }}>
                        ...
                        <div style={{zindex: 10 }} onclick={(e)=>{console.log(e.target)}}>
                            <button style={{ color: '#929398', border: "none", outline: "none", backgroundColor: "transparent", color: "blueviolet" }} onclick={() => {
                                console.log("Clicked")

                            }}>Edit</button>
                            •
                            <button className="btn btn-primary" style={{ color: '#929398', border: "none", outline: "none", backgroundColor: "transparent", color: "red" }} onclick={() => {
                                console.log("Clicked")
                                dispatch({ type: DELETE_COMMENT_SAGA, commentId: comment.id })

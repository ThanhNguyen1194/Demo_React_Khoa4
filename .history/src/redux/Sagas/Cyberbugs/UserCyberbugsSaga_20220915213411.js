...
import { GET_LIST_USER, GET_LIST_USER_SAGA, GET_USER_BY_PROJECT_ID, GET_USER_BY_PROJECT_ID_SAGA, SIGN_UP_USER_SAGA } from '../../constants/Cyberbugs/UserConstatnts';
...
export function* theoDoiSignUpUserSagaSaga() {
...
function* getListUserSaga(action) {
    ...
    try {
        const { data, status } = yield call(() => userService.signUpUser());
        // console.log('checkdata',data);
...
export function* theoDoiGetListUserSagaSaga() {

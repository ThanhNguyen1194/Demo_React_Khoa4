...
import { GET_USER_BY_PROJECT_ID, GET_USER_BY_PROJECT_ID_SAGA, SIGN_UP_USER_SAGA } from '../../constants/Cyberbugs/UserConstatnts';
...
function* signUpUserSaga(action) {
    ...
    try {
        ...
        console.log(err);
        console.log(err.response?.data);
        notifiFunction('error','Sign Up project fail !')

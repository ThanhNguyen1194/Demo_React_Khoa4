...
import { EDIT_USER_SAGA, GET_LIST_USER, GET_LIST_USER_SAGA, GET_USER_BY_PROJECT_ID, GET_USER_BY_PROJECT_ID_SAGA, SIGN_UP_USER_SAGA } from '../../constants/Cyberbugs/UserConstatnts';
...
export function* theoDoiDeleteUserSaga() {
    yield takeLatest(EDIT_USER_SAGA, deleteUserSaga)
}
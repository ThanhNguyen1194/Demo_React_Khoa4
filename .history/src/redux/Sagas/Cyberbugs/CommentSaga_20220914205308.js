...
import { GET_ALL_COMMENTS, GET_ALL_COMMENTS_SAGA, INSERT_COMMENT_SAGA } from "../../constants/Cyberbugs/CommentConstans";
...
export function* theoDoiDeleteCommentSaga() {
    yield takeLatest(INSERT_COMMENT_SAGA, deleteComment);
}
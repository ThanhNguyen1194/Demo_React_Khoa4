...
export default function UserManagement(props) {
  ...
  return (
    ...
    <div style={{display: 'flex',alignItems: 'center',justifyContent: 'center',fontSize: '20px',}}>
        ...
        <img src={userLogin.avatar} style={{width: '50px', height: '50px', borderRadius: '50%',marginLeft:'10px'}} alt="User Management" />
        <i fontSize="50px"><CaretDownOutlined style={{fontSize: '50px'}}/></i>
        {console.log(userLogin)}
    </div>
    </div>
    <div className="pb-3 font-weight-bold" style={{ fontSize: 20 }}>
    <a>Create User</a>
    </div>

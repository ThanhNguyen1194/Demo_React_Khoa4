...
import SignUpCyberBug from '../SignUpCyberBug/signUpCyberBug';
...
export default function UserManagement(props) {
    ...
    return (
        <div className="container-fluid m-5">
            ...
            <div className="mb-3 font-weight-bold" style={{ fontSize: 20 }} onClick={()=>{
                dispatch({
                    type:'OPEN_FORM_CREATE_USER',
                    title: 'Create User',
                    Component: <SignUpCyberBug/>
                })
            ...
            <div className='mb-4'>
                ...
                <Button type="primary" size={'default'} style={{ width: '10%' }} className="ml-3">
                    Search
                </Button>
            </div>

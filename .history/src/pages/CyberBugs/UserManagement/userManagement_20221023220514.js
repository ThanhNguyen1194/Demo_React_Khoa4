        ...
        <div className="container-fluid m-5">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '20px', position: "relative" }}>
                    ...
                    <i style={{ cursor: "pointer" }} onClick={() => { }}><CaretDownOutlined style={{ fontSize: '50px' }} /></i>
                    <div style={{ position: 'absolute', bottom: -65, right: -30, height: 80, display: "flex", alignItems: "end", display: {} }}>

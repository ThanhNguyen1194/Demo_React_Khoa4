    ...
    return (
        <form onSubmit={handleSubmit} className="container" style={{ height: window.innerHeight }} >
            <div className="d-flex flex-column justify-content-center align-items-center" style={{ height: window.innerHeight }} >
                <h3 className="text-center" style={{ fontWeight: 600, fontSize: 30 }}>LOGIN JIRA CLONE</h3>
                ...
                <div>
                    ...
                    <NavLink activeClassName='bg-dark' activeStyle={{color: 'pink', fontSize: '20px', borderRadius: '5px'}} className="nav-link" to="/signupjira">Sign Up</NavLink>
                        </p>
                </div>

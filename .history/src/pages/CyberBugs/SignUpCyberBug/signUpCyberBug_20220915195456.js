...
const SignUpCyberBugsWithFormik = withFormik({
    ...
    validationSchema: Yup.object().shape({
        ...
        phoneNumber: Yup.string().min(6, 'password must have min 6 characters').max(32, 'password  have max 32 characters'),
        name: Yup.string().min(6, 'password must have min 6 characters').max(32, 'password  have max 32 characters'),

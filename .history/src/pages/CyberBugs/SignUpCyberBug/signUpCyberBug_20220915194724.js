 ...
 const handleChange = () => {}
  return (
    ...
    <div className="d-flex flex-column justify-content-center align-items-center" style={{ height: window.innerHeight }} >
        ...
        <div className="d-flex mt-3">
            <Input onChange={handleChange} style={{ width: '100%', minWidth: 300 }} type="phoneNumber" name="password" size="large" placeholder="password" prefix={<PhoneOutlined />} />
        </div>
        {/* <div className="text-danger">{errors.password}</div> */}
        <div className="d-flex mt-3">
            <Input onChange={handleChange} style={{ width: '100%', minWidth: 300 }} type="name" name="password" size="large" placeholder="password" prefix={<LockOutlined />} />
        </div>
        {/* <div className="text-danger">{errors.password}</div> */}
